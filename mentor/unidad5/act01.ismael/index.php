<?php
    ...
    if(isset($_REQUEST['operacion'])) switch ($_REQUEST['operacion'])
    {
        case 'comprar':
            $f = $_REQUEST['la_fila'];
        ...
        case 'confirm':
            ...
            if ($play->reservar($_SESSION['historial']) > 0) {
                $_SESSION['butacas'] = 0;
                $_SESSION['historial'] = array();
                $mensaje = "La reserva se realizó con exito";       
            }
            else 
                $mensaje = "Algo pasó con la reserva";
            break;
...
<body bgcolor="#C0C0C0" link="green" vlink="green" alink="green">
    ...
    <table border="0" align="center" cellspacing="3" cellpadding="3" width="650">
        <tr>
            <th colspan="2" width="100%" bgcolor="green"><FONT size="6" color="white">
                    Comprar entradas de teatro</FONT></th>
        </tr>
    </table>
        ...
        <tr>
            <?php
                echo "<td valign=top align=CENTER colspan=2>
                    Numero de butacas disponibles: ".(5-$_SESSION['butacas'])."</td></tr>";
